...
async function getRONPrice() {
    try {
        ...
        const provider = new ethers_1.ethers.JsonRpcProvider('https://saigon-testnet.roninchain.com/rpc');
        // Tạo đối tượng hợp đồng Price Feed
        const priceFeed = new ethers_1.ethers.Contract(PRICE_FEED_ADDRESS, PRICE_FEED_ABI, provider);
