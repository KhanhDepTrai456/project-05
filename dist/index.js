...
async function checkBalance(walletAddress, tokenAddress) {
    try {
        ...
        const provider = new ethers_1.ethers.JsonRpcProvider(RONIN_SAIGON_RPC);
        ...
        // Chuyển đổi số dư từ Wei sang đơn vị token
        ...
        console.log(`Số dư: ${balanceInToken.toFixed(decimals)} ${symbol}`);
    }
    catch (error) {
